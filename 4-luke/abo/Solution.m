classdef Solution
    ...
    methods(Static)
      ...
      function koef = kp3PremaTEUpremaStarosti(kb1, godinaStarosti)
          if kb1 < 600
              koef = Solution.starostKoef([1.05, 1.20, 1.45, 2.09, 3.03, 3.91], godinaStarosti);
          elseif kb1 < 800
              koef = Solution.starostKoef([0.88, 1.02, 1.14, 2.07, 2.99, 3.87], godinaStarosti);
          elseif kb1 < 1000
              koef = Solution.starostKoef([0.74, 0.80, 0.96, 2.01, 2.96, 3.83], godinaStarosti);
          elseif kb1 < 1200
              koef = Solution.starostKoef([0.65, 0.69, 0.84, 1.98, 2.93, 3.79], godinaStarosti);
          elseif kb1 < 1500
              koef = Solution.starostKoef([0.55, 0.62, 0.75, 1.94, 2.90, 3.76], godinaStarosti);
          elseif kb1 < 2000
              koef = Solution.starostKoef([0.48, 0.55, 0.66, 1.92, 2.88, 3.72], godinaStarosti);
          elseif kb1 < 2500
              koef = Solution.starostKoef([0.40, 0.46, 0.53, 1.81, 2.84, 3.69], godinaStarosti);
          elseif kb1 < 3000
              koef = Solution.starostKoef([0.35, 0.45, 0.59, 1.77, 2.80, 3.64], godinaStarosti);
          elseif kb1 < 3500
              koef = Solution.starostKoef([0.32, 0.36, 0.44, 1.73, 2.77, 3.61], godinaStarosti);
          elseif kb1 < 4000
              koef = Solution.starostKoef([0.28, 0.33, 0.47, 1.70, 2.73, 3.59], godinaStarosti);
          elseif kb1 < 4500
              koef = Solution.starostKoef([0.27, 0.31, 0.36, 1.65, 2.68, 3.55], godinaStarosti);
          elseif kb1 < 5100
              koef = Solution.starostKoef([0.25, 0.28, 0.33, 1.62, 2.65, 3.53], godinaStarosti);
          else
              koef = Solution.starostKoef([0.23, 0.26, 0.31, 1.60, 2.63, 3.50], godinaStarosti);
          end
      end
